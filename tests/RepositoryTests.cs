...
public class RepositoryTests
{
    ...
    { 
        ...
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
        homeRepository.SetModifier(1, 17, "Strength");
    ...
    [Test]
    public void RepositoryCanAttackNewCharactersAndOnModifierChangesHitStrengthCriticalHitDoublesModifier()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("ModifierChangesHitStrengthModifierDoublesHit").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
        homeRepository.SetModifier(1, 8, "Strength");
    ...
    [Test]
    public void RepositoryCanAttackNewCharactersAndOnModifierChangesArmorAmount()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
        ...
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
        homeRepository.SetModifier(1, 4, "Dexterity");
    ...
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("ModifierChangesHitArmorAmountMisses").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
    ...
    [Test]
    public void RepositoryCanAttackNewCharactersAndOnFifteenModifierBoostsHp()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("ModifierFifteenBoostsHp").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can increase HitPoints");
        
        homeRepository.SetModifier(1, 15, "Constitution");

        Assert.That(evercraftDbContext.DnDCharacters.First().HitPoints, Is.EqualTo(7));
    }
    
    [Test]
    public void RepositoryCanAttackNewCharactersAndToLowerModifierDoesNotChangeHitpoints()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("ModifierDoesNotChangeHitPoint").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can increase HitPoints");
    ...
    [Test]
    public void RepositoryCanAttackNewCharactersAndAtOneHitpointDiesHeroGainsExperience()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("CanGainExperience").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
    ...
    [Test]
    public void RepositoryCanAttackNewCharactersAndAtOneHitPointDiesHeroGainsALevelAndHitPointsModifiedByConstitution()
    { 
        var dbContextOptions = new DbContextOptionsBuilder<EvercraftDbContext>()
            .UseInMemoryDatabase("CanGainLevelsModifiedByConstitution").Options;
        var evercraftDbContext = new EvercraftDbContext(dbContextOptions);
        var homeRepository = new HomeRepository(
            evercraftDbContext);
        homeRepository.CreateCharacter("can attack character");
